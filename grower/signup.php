...
<div class="container">
<a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white" href="www.aduanefie.com">
ADUANEFIE MARKET PLACE
</a>
...
<li class="nav-item">
<a class="nav-link me-2" href="index.php?page=signup">
<i class="fas fa-user-circle opacity-6  me-1"></i>
Sign Up
</a>
</li>
<li class="nav-item">
<a class="nav-link me-2" href="index.php?page=login">
...
<a class="btn btn-round btn-sm mb-0 btn-outline-white me-2" target="_blank" href="https://www.aduanefie.com">Visit Our Website</a>
</li>
...
Are You A Grower Signup Here For An Awesome Experience
</p>
</div>
</div>
</div>
...
I agree the <a href="javascript:;" class="text-dark font-weight-bolder">Terms and Conditions as remote marketer</a>
</label>
</div>
<div class="text-center">
<button type="button" class="btn bg-gradient-dark w-100 my-4 mb-2">Sign up</button>
</div>
<p class="text-sm mt-3 mb-0">Already have an account? <a href="index.php?page=login" class="text-dark font-weight-bolder">Sign in</a></p>
</form>
</div>
</div>
</div>
