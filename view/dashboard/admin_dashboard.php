...
<span class="text-white text-sm">Registered Active Users</span>
</div>
<div class="col-4">
...
<span class="text-white text-sm">Registered Marketers</span>
</div>
<div class="col-4">
...
<span class="text-white text-sm">Registered Growers</span>
</div>
<div class="col-4">
<div class="dropdown text-end mb-6">
...
<span class="text-white text-sm">Insured Growers</span>
</div>
<div class="col-4">
<div class="dropstart text-end mb-6">
...
<h6 class="mb-0">Onboard Reviews</h6>
</div>
...
<span class="me-2 text-sm font-weight-bold text-dark">Onboarded This Week</span>
...
<div class="w-100">
<div class="d-flex mb-2">
<span class="me-2 text-sm font-weight-bold text-dark">Onboarded This Month</span>
...
<a class="btn btn-dark mb-0 text-end" href="index.php?page=onboardedlist">
View all onboarded
</a>
</div>
</div>
...
<h6>Loans Overview</h6>
<p class="text-sm">
<i class="fa fa-arrow-up text-success"></i>
<span class="font-weight-bold">4% more</span> in <?php echo date('Y')-2; ?>
</p>
</div>
...
<h6 class="ms-2 mt-4 mb-0"> Insurance & Loan Analysis </h6>
...
<p class="text-xs mt-1 mb-0 font-weight-bold">Growers with Insurance</p>
</div>
...
<p class="text-xs mt-1 mb-0 font-weight-bold">Growers with Loans</p>
</div>
...
Farming is not just a profession, it’s a way of life. Keep growing!
</a>
</li>
</ul>
</div>
